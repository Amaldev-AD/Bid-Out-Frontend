...
import { Caption, Heading } from '../ui/Design';
...
const TopCollection = () => {
  return (
    <>
     <section className="process py-12 px-10 lg:pl-[320px] z-10">
        <div>
          <Heading
          ...
          <div className="content grid grid-cols-1 md:grid-cols-2 xl-grid:grid-cols-4 gap-5 mt-8">
